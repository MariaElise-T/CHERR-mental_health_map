...
poverty_rates_2020 <- read_excel("Desktop/dashboard_data/data_raw/est20all.xls", skip = 3)
...
chronic_conditions_2018 <- read_excel("Desktop/dashboard_data/data_raw/County_Table_Chronic_Conditions_Prevalence_by_Age_2018.xlsx", sheet = "All Beneficiaries")
...
unemployment <- read.csv("~/Desktop/dashboard_data/data_raw/laucntycur14.txt", header=FALSE, sep="|")
...
incarceration_trends <- read.csv("~/Desktop/dashboard_data/data_raw/incarceration-trends/incarceration_trends.csv")
incarceration_trends <- incarceration_trends[which(incarceration_trends$year==2018),]
...
write.csv(social_medical, "/Users/maria/Desktop/dashboard_data/data_intermediate/social_medical.csv", row.names=F)
