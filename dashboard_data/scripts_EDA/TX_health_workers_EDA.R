...
LCSWs <- TX_health_workers_2020[,c("Name", "Ratio.of.LCSWs.to.100.000.Population", "RUCC_2013", "NCHS_2013", "UIC_2013")]
LCSWs$Role <- "Clinical"
colnames(LCSWs) <- c("County", "Count.per.100k", "RUCC_2013", "NCHS_2013", "UIC_2013", "Role")

LBSWs <- TX_health_workers_2020[,c("Name", "Ratio.of.LBSWs.to.100.000.Population", "RUCC_2013", "NCHS_2013", "UIC_2013")]
LBSWs$Role <- "Baccalaureate"
colnames(LBSWs) <- c("County", "Count.per.100k", "RUCC_2013", "NCHS_2013", "UIC_2013", "Role")

LMSWs <- TX_health_workers_2020[,c("Name", "Ratio.of.LMSWs.to.100.000.Population", "RUCC_2013", "NCHS_2013", "UIC_2013")]
LMSWs$Role <- "Master"
